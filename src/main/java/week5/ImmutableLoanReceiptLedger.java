...
public class ImmutableLoanReceiptLedger {
            ...
            for (String id : bookIds) {
                if (id == null || !id.matches("^BK-\\d{3}$")) {
                    throw new IllegalArgumentException(
                            "Invalid book ID format: '" + id + "'. Must match BK- followed by 3 digits.");
                }
            }
    ...
    public static int getTotalCirculationBatches() {
        return totalCirculationBatches;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total batches processed: " + getTotalCirculationBatches());
    }
}