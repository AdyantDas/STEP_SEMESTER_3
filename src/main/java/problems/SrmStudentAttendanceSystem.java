...
public class SrmStudentAttendanceSystem {
    ...
    public static class SrmStudent {
        ...
        /*
         * JUSTIFICATION:
         * - 'isEligible()' is an instance method because eligibility is a property of a
         * specific
         * individual student based on their own private attendance score.
         * - 'classAverage(SrmStudent[] students)' is static because the concept of a
         * class average
         * does not belong to any single student object; it is a batch/utility operation
         * that computes
