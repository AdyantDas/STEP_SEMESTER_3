...
public class LibraryFineSystem {
    ...
    public static class BookIssue {
        ...
        /*
         * JUSTIFICATION:
         * - 'fineAmount()' is an instance method because fine calculation is specific
         * to an
         * individual book issue (depends on its unique daysOverdue state).
         * - 'totalFineCollected(BookIssue[] issues)' is static because summing the
         * total fine
         * is a aggregate calculation over a collection of BookIssue objects and does
         * not belong
