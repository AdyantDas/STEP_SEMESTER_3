...
public class ParkingSlotAllocation {
     ...
     * In Java, passing an array of objects passes references to the underlying
     * objects on the heap.
     * It does not create copies of the ParkingSlot instances. Thus,
     * slot.allot(vehicleNo) mutates
